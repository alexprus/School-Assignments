...
int main(){
    ...
    BmodeClass *currentScanline = scanlineHead; // Initialize head of linked list
    currentData = dataHead; // Set currentData to dataHead
...
// Builds linked list 
        ...
        currentScanline = currentScanline -> next; // Advances the current position in the list to the next positon
        currentScanline -> next = NULL; // Sets end of the list to NULL
    }
